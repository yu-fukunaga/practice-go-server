...
// SetPassHash sets the "pass_hash" field.
func (m *UserMutation) SetPassHash(s string) {
	m.pass_hash = &s
}

// PassHash returns the value of the "pass_hash" field in the mutation.
...
// OldPassHash returns the old "pass_hash" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
...
// ResetPassHash resets all changes to the "pass_hash" field.
