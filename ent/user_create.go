...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.PassHash(); !ok {
		return &ValidationError{Name: "pass_hash", err: errors.New(`ent: missing required field "User.pass_hash"`)}
	}
	if _, ok := uc.mutation.CreatedAt(); !ok {
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.PassHash(); ok {
		_spec.SetField(user.FieldPassHash, field.TypeString, value)
